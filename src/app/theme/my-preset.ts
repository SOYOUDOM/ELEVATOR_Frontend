...
export const ElevatorPreset = definePreset(Aura, {
  ...
  primitive: {
    ...
    elevator: {
      ...
      accentSoft: 'color-mix(in oklch, #ffffff 22%, transparent)',
      accentGlow: 'color-mix(in oklch, #ffffff 40%, transparent)',
      accentGlowExtreme: 'color-mix(in oklch, #ffffff 90%, transparent)',
      accentDim: 'color-mix(in oklch, #ffffff 55%, #0a0e14)',
      corner: '13px',
      maxw:   '1240px',
