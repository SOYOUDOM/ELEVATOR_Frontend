...
const ELEVATOR_DARK: ThemeTokens = {
  ...
  accent: '#ffd35b',
  accentInk: '#1a1204',
  accentSoft: 'rgba(255, 211, 91, .22)',
  accentWash: 'rgba(255, 211, 91, .12)',
  accentWash2: 'rgba(255, 211, 91, .24)',
  accentFaint: 'rgba(255, 211, 91, .07)',
  accentGlow: 'rgba(255, 211, 91, .40)',
  accentGlowExtreme: 'rgba(255, 211, 91, .90)',
  accentDim: '#8f7735',

  good: '#3fd68b',
  goodWash: 'rgba(63, 214, 139, .16)',
  goodInk: '#041e12',
  caution: '#f0b35b',
  cautionWash: 'rgba(240, 179, 91, .16)',
  cautionInk: '#20150a',
  warn: '#ff6b8a',
  warnWash: 'rgba(255, 107, 138, .16)',
  warnSoft: 'rgba(255, 107, 138, .50)',
  warnInk: '#2a0511',
  ...
  paperRuleSoft: 'rgba(16, 18, 21, .07)',
...
const PRESS_DARK: ThemeTokens = {
  ...
  accentFaint: 'rgba(34, 184, 232, .09)',
...
const CARBON: ThemeTokens = {
  ...
  accentFaint: 'rgba(77, 210, 255, .12)',
