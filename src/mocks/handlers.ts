...
// import abpConfig from './abp-config.json';
// import session from './session.json'; // if you saved it; otherwise use the inline stub below
...
export const handlers = [
    ...
    http.get('*/api/services/app/Session/GetCurrentLoginInformations',
        () => HttpResponse.json({
    "result": {
        "application": {
            "version": "9.3.0",
